...
/**
 * Azure Stack Compute sample for creating virtual machine using custom user image.
 */
public final class CreateVirtualMachine {
     ...
     */
    public static boolean createVm(Azure azure, String location) {
        ...
        final String customImageUrl = System.getenv("AZURE_CUSTOM_IMAGE_URL");
        ...
        try {
            ...
            vmStorageProfile.osDisk().withImage(new VirtualHardDisk().withUri(customImageUrl)); 
    ...
    public static void main(String[] args) {
        try {
            ...
            final String location = System.getenv("AZURE_RESOURCE_LOCATION");
